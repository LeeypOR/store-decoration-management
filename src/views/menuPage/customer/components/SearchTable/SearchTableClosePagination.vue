  ...
  <div class="search-table">
    ...
    <a-row class="search-table-list">
      ...
      <a-table
        ...
        :scroll="{ x: xLength }"
      >
        <span class="nowrap" slot="card" slot-scope="text, record">
            <div :style="{'background-color':record.backgroundColor,'width': '135px','height':'70px','border-radius':'8px'}">
              <img :src="record.backgroundPicture" style="width: 135px;height:70px;border-radius:8px;" alt="">
            </div>
        </span>
