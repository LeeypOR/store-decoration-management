  ...
  <div class="search-table">
    ...
    <a-row class="search-table-list">
      ...
      <a-table
        ...
        :scroll="{ x: xLength }"
      >
        <span class="nowrap" slot="cardName" slot-scope="text, record">
          <slot name="cardName" :record="record"></slot>
        </span>

        <span class="" slot="labelList" slot-scope="text, record">
          <slot name="labelList" :record="record"></slot>
        </span>
    ...
    return {
      rowSelection: {
        ...
        getCheckboxProps(record) {
          return {
            props:{
              disabled: record[_this.disabledKey] == 0 ? true: false
            }
          }
        },
      ...
      this.$get(this.url,
        ...
        if (res && res.returnCode === 1000) {
          ...
          this.dataSource.forEach((item,index)=>{
            this.$set(item,'xuhao',(this.pagination.current-1)*10+index+1)
          })
