    ...
    getList (current = '', size = '') {
      ...
      this.$get(this.url,
        ...
        if (res && res.returnCode === 1000) {
          console.log('res:',res)
          this.selectedRowKeys = this.chosenCouponKeys
          this.selectedRows = this.chosenCouponRights
          this.rowSelection.selectedRowKeys = this.chosenCouponKeys
          console.log(this.selectedRowKeys,this.selectedRows)
          //this.dataSource = res.dataInfo.records || []
          this.dataSource = (res.dataInfo || {}).records || []
          this.dataSource = this.dataSource.filter((item)=>{
            return item.couponStatus ===0
          })
          if(this.pagination) {
