<template>
  ...
  <!--    <a-form-item  >
      ...
      <a-form-item >
        <template slot="label">
          <span class="ant-form-item-required">会员日</span>
        </template>
          <div style="line-height: 40px">
            每月的
            <a-input-number  :min="1" :max="31" style="width: 153px;" @blur="memberDayChange" v-model="makePointData.memberDay"></a-input-number> 号
          </div>
      </a-form-item>
      ...
      <a-form-item>
        ...
        <span style="line-height: 40px;"> 会员日超低价</span>
            <a-button type="link"
                      :disabled="!islowprice"
                      @click="openModel">{{makePointData.chooseActPage}}</a-button>
            <span style="color: darkgray">注：需先在店铺装修配置会员日活动微页面</span>
            <br>
            <div style="margin-left: 50px;">
              <a-radio-group v-show="islowprice && makePointData.mspageId" v-model="makePointData.issueAging2"  @change="issueAgingChange2">
                ...
                <a-input-number :disabled="makePointData.issueAging2 !=2" v-model="makePointData.validDuration" :min="1"></a-input-number> 天内可查看
              </a-radio-group>
            </div>
        ...
        <div>
         ...
         <br>
         <span style="margin-left: 27px;" >发放条件： 会员日当天发放</span>
        ...
        <div>
          ...
          <span style="color: darkgray;">注：设置用户会员日当天购物返积分的倍数</span>
        </div>
      </a-form-item>
<!--      <a-form-item >
        <template slot="label">
    ...
    methods: {
      ...
      async getInfo() {
        ...
        if (this.formData.id) {
          ...
          this.makePointData.memberDay = this.formData.memberDay
          ...
          // this.makePointData.integralRatio = this.formData.integralRatio ==null?1:this.formData.integralRatio
      ...
      memberDayChange(){
        // console.log(  this.makePointData.memberDay)
        this.makePointData.memberDay = parseInt(this.makePointData.memberDay)
        // console.log(  this.makePointData.memberDay)
      },
      handleCancel() {
        this.$router.push(
      ...
      submitData() {
       ...
       /*   let popupWindowStyle;
          ...
          this.$post('goldenhome/member/admin_/member/benefits/update', {
            ...
            memberDay: this.makePointData.memberDay,
